...
Usage: python Tools/_WF/ShipPa/gen_speaker_rsi.py
Writes into Resources/Textures/_WF/ShipPa/Structures/Wallmounts/ship_speaker.rsi/
"""
...
OUT_DIR = os.path.normpath(os.path.join(
    ...
    "Resources", "Textures", "_WF", "ShipPa", "Structures", "Wallmounts", "ship_speaker.rsi",
))
