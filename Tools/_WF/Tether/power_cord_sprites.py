...
drawn here in the same flat cassette-futurism style as the tow eye plate.
    ...
    python Tools/_WF/Tether/power_cord_sprites.py [path/to/cable_rope.png]
...
DEFAULT_SOURCE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "cable_rope.png")
