...
into Resources/Textures/_WF/Genitals/Mobs/Customization/TailSplit/<source rsi path>, and rewrites the marking
...
Run from the repository root (requires Pillow and PyYAML):
    python Tools/_WF/Genitals/tails/split_tails_batch.py --report
    python Tools/_WF/Genitals/tails/split_tails_batch.py --apply
    python Tools/_WF/Genitals/tails/split_tails_batch.py --mode zone --report --json zone.json
    python Tools/_WF/Genitals/tails/split_tails_batch.py --mode zone --apply
    python Tools/_WF/Genitals/tails/split_tails_batch.py --mode zone --verify
"""
import argparse
import json
import os
...
OUT_ROOT = "_WF/Genitals/Mobs/Customization/TailSplit"
DONE_ROOTS = (OUT_ROOT, "_WF/Genitals/Mobs/Customization/protogen_tails.rsi")
SPLIT_NOTE = "South frame separated onto the TailBehind layer for Wolfgate."
BEHIND_LAYER = "TailBehind"
FRONT_SUFFIX = "_FRONT"
BEHIND_SUFFIX = "_BEHIND"

MARK_SPLIT_ART = "# WOLFGATE(Genitals): split art"
MARK_BEHIND_ART = "# WOLFGATE(Genitals): south frame on TailBehind"
MARK_LAYERING = "# WOLFGATE(Genitals): the south frame draws behind the body, so the tail never covers anatomy"
MARK_LINKS = "# WOLFGATE(Genitals): both halves of a tail share one colour"
MARK_PLAIN = "# WOLFGATE(Genitals)"
MARK_RENAME = "# WOLFGATE(Genitals): renamed by the south split"
...
MARK_ZONE_ART = "# WOLFGATE(Genitals): split art, anatomy zone only"
MARK_ZONE_BEHIND = "# WOLFGATE(Genitals): anatomy zone of the south frame on TailBehind"
MARK_ZONE_LAYERING = ("# WOLFGATE(Genitals): the anatomy zone of the south frame draws behind the body, "
