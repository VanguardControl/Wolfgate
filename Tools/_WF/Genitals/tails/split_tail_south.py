...
Run from the repository root (requires Pillow):
    python Tools/_WF/Genitals/tails/split_tail_south.py _Mono/Mobs/Customization/protogen_parts.rsi tail_protogen bushy_tail_protogen shark_tail_protogen

<rsi> and --out are relative to Resources/Textures. Split states are merged into --out (default
_WF/Genitals/Mobs/Customization/protogen_tails.rsi); the source RSI is never modified.
"""
import argparse
import json
import os
...
DEFAULT_OUT = "_WF/Genitals/Mobs/Customization/protogen_tails.rsi"
