"""Builds Resources/Textures/_WF/Genitals/Mobs/Customization/Markings/Genital/sheath.rsi from NovaSector's sheath art.
...
OUT = os.path.join(ROOT, "Resources", "Textures", "_WF", "Genitals", "Mobs", "Customization", "Markings", "Genital", "sheath.rsi")
DX, DY = 0, 0
