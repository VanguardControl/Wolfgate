"""Generates the Wolfgate UI textures for every skin under Resources/Textures/_WF/Stylesheets/Interface/<skin>.

Run from the repository root:  python Tools/_WF/Stylesheets/WolfgateUiTextures/generate_textures.py
...
Resources/Textures/_WF/Genitals/Interface serves every skin.
"""
import math
import os
import shutil
...
def attributions():
    ...
    lines = [
        ...
        '  copyright: "Generated for Wolfgate by Tools/_WF/Stylesheets/WolfgateUiTextures/generate_textures.py"',
...
def anatomy_icon():
    ...
    out_dir = os.path.join(ROOT, "Resources", "Textures", "_WF", "Genitals", "Interface")
...
def window_icons():
    ...
    out = os.path.join(ROOT, "Resources", "Textures", "_WF", "UserInterface", "Interface", "Window")
...
def main():
    ...
    for skin, palette in SKINS.items():
        P = palette
        OUT = os.path.join(ROOT, "Resources", "Textures", "_WF", "Stylesheets", "Interface", skin)
