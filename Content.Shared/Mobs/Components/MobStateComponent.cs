...
namespace Content.Shared.Mobs.Components
{
    ...
    [RegisterComponent]
    [NetworkedComponent]
    [AutoGenerateComponentState(raiseAfterAutoHandleState: true)] // WOLFGATE(Wolfmed): crit heartbeat needs a client-side signal for a server-only MobState change
