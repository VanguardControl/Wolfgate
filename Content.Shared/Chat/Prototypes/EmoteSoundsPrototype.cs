...
using Robust.Shared.Serialization.TypeSerializers.Implementations.Custom.Prototype.Array; // WOLFGATE
...
public sealed partial class EmoteSoundsPrototype : IPrototype, IInheritingPrototype // WOLFGATE
{
    [IdDataField]
    public string ID { get; private set; } = default!;

    // WOLFGATE START: ported from HardLight, emote sound sets can inherit so species sets can share a
