...
/// Goobstation Section Start - Tajaran
    ...
    public static bool VerifySkinColor(HumanoidSkinColor type, Color color)
    {
        return type switch
        {
            ...
            HumanoidSkinColor.AnyColour => true, // WOLFGATE(Species): ported from HardLight
            _ => false,
        };
    }
    ...
    public static Color ValidSkinTone(HumanoidSkinColor type, Color color)
    {
        return type switch
        {
            ...
            HumanoidSkinColor.AnyColour => color, // WOLFGATE(Species): ported from HardLight
            _ => color
        };
    }
}
...
public enum HumanoidSkinColor : byte
{
    ...
    AnyColour, // WOLFGATE(Species): ported from HardLight, unrestricted skin colour
}
