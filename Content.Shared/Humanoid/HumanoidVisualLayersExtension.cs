        ...
        public static IEnumerable<HumanoidVisualLayers> Sublayers(HumanoidVisualLayers layer)
        {
            switch (layer)
            {
                ...
                case HumanoidVisualLayers.Chest:
                    ...
                    yield return HumanoidVisualLayers.TailBehind; // WOLFGATE(Genitals): split tail layers
                    yield return HumanoidVisualLayers.TailOversuit; // WOLFGATE(Genitals): split tail layers
                    break;
