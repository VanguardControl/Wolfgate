...
- **Reports:** the per-phase analyst, critique, work-package and verification reports were removed from the repo on 2026-09-14 to slim the PR; they live locally at `C:\Users\jzo12\Documents\Wolfmed\plan\reports` (same layout: `analysis/`, `analysis/phaseN/`, `work-packages/`, `work-packages/phaseN/`). Manifest rows that cite `Docs/_WF/Wolfmed/reports/...` refer to that local copy.
