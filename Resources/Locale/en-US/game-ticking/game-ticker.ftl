...
# WOLFGATE(Branding) START: Wolfgate's name instead of Monolith's
game-ticker-player-join-game-message = Welcome to Wolfgate! If this is your first time playing, be sure to read the game rules, and don't be afraid to ask for help in LOOC (local OOC) or OOC (usually available only between rounds).
game-ticker-get-info-text = Hi and welcome to [color=white]Wolfgate![/color]
                            The current round is: [color=white]#{$roundId}[/color]
                            The current player count is: [color=white]{$playerCount}[/color]
                            The current game mode is: [color=white]{$gmTitle}[/color]
                            >[color=yellow]{$desc}[/color]
game-ticker-get-info-preround-text = Hi and welcome to [color=white]Wolfgate![/color]
                            The current round is: [color=white]#{$roundId}[/color]
