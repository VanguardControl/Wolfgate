...
public sealed partial class WFAnchorCapacitySystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<WFGridAnchorLoadComponent, WFGridLiftLoadEvent>(OnLiftLoad);
    }

    /// <summary>Crated and loose anchors aboard weigh against the grid's pooled lift.</summary>
    private void OnLiftLoad(Entity<WFGridAnchorLoadComponent> ent, ref WFGridLiftLoadEvent args)
    {
        args.Mass += ent.Comp.VirtualMass;
    }
