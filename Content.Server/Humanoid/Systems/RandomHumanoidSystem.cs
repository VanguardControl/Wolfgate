...
public sealed partial class RandomHumanoidSystem : EntitySystem
{
    ...
    public EntityUid SpawnRandomHumanoid(string prototypeId, EntityCoordinates coordinates, string name)
    {
        ...
        // WOLFGATE START: random humanoids never roll a subspecies. Those are variants picked on purpose, and the 14 Proto
        ...
        {
            if (species.SubspeciesOf != null)
                blacklist.Add(species.ID);
        }
