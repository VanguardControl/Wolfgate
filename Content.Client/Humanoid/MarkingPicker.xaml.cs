...
using Robust.Client.Graphics; // WOLFGATE
...
public sealed partial class MarkingPicker : Control
{
    ...
    {
        CMarkingsUsed.Clear();
        CMarkingColorsCard.Visible = CMarkingColors.Visible = false; // WOLFGATE
    ...
    private void OnUsedMarkingSelected(ItemList.ItemListSelectedEventArgs item)
    {
        ...
        List<WolfgateColorPicker> colorSliders = new(); // WOLFGATE: swatches + sliders
        ...
        CMarkingColorsCard.Visible = CMarkingColors.Visible = true; // WOLFGATE
    }
