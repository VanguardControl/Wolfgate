...
public sealed partial class RoofOverlay : Overlay
{
    ...
    [Dependency] private ITileDefinitionManager _tileDefs = default!; // WOLFGATE
        ...
        worldHandle.RenderInRenderTarget(target,
            () =>
            {
                for (var i = 0; i < _grids.Count; i++)
                {
                    ...
                    {
                        // WOLFGATE: open grating is no roof. Lattice is a space tile, and the planet cracker's gangway
                        // is laid in it on a hull that keeps its implicit roof; painted over, it blacked out the world
                        // below whenever the eye crossed it.
