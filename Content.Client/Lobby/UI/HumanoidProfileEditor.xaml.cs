...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
            ...
            CompanyManager manager) // Mono
        {
            ...
            {
                // WOLFGATE START: ask before a save that would clear anatomy
            ...
            TabContainer.SetTabTitle(1, Loc.GetString("humanoid-profile-editor-appearance-tab")); // WOLFGATE: shifted by the species tab

            #region Sex

            SexSelector.OnSexSelected += SetSex; // WOLFGATE

            // WOLFGATE START: species name override; blank falls back to the species' own name
            ...
            // WOLFGATE START: description box under the preview, plus a full-size editor for longer text
            ...
            TabContainer.SetTabTitle(2, Loc.GetString("humanoid-profile-editor-jobs-tab")); // WOLFGATE: shifted by the species tab
            ...
            TabContainer.SetTabTitle(4, Loc.GetString("humanoid-profile-editor-company-tab")); // WOLFGATE: shifted by the species tab
            ...
            TabContainer.SetTabTitle(5, Loc.GetString("humanoid-profile-editor-markings-tab")); // WOLFGATE: shifted by the species tab
            ...
            // WOLFGATE START: anatomy tab, found by position so a tab added or moved upstream cannot shift it
        ...
        public void RefreshTraits()
        {
            ...
            TabContainer.SetTabTitle(3, Loc.GetString("humanoid-profile-editor-traits-tab")); // WOLFGATE: shifted by the species tab
        ...
        public void RefreshSpecies()
        {
            ...
            // WOLFGATE START: populate the species picker and sync its selection
        ...
        private void ReloadPreview()
        {
            ...
            // WOLFGATE START: the doll wears job clothes only in the As worn anatomy preview
        ...
        public void SetProfile(HumanoidCharacterProfile? profile, int? slot)
        {
            ...
            UpdateSaveButton();
            UpdateMarkings();
            // WOLFGATE START: sync the anatomy tab and doll with the loaded profile
            UpdateGenitalEditor();
            if (Profile != null)
        ...
        {
            // WOLFGATE START: body split out so the species tab's per-card info buttons can reach it
        ...
        private void OpenSpeciesGuidebook(string species)
        {
            ...
            // WOLFGATE START: species is now a parameter, computed by the caller instead
        ...
        // WOLFGATE START: full-size description editor
        ...
        // WOLFGATE START: live description counter and warnings
        /// <summary>
        ...
        private void OnSkinColorOnValueChanged()
        {
            ...
            switch (skin)
            {
                ...
                // WOLFGATE START: ported from HardLight, unrestricted skin colour
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            _loadoutWindow?.Dispose();
            _loadoutWindow = null;
            // WOLFGATE START: also close the job title and anatomy confirm windows
            CloseCustomJobTitle();
        ...
        private void SetSpecies(string newSpecies)
        {
            ...
            // WOLFGATE START: keep the species picker and dropdown in step, drop hair the new species lacks
            EnforceSpeciesHair();
        ...
        // WOLFGATE START: drop hair the new species lacks
        /// <summary>
        ...
        {
            // WOLFGATE START: keep the live description status in step when the profile reloads
        ...
        {
            // WOLFGATE START: otherwise the previous character's segments stay visible and lit
            if (Profile == null)
            {
            ...
            // WOLFGATE START: an icon box per sex, and a real SetSex when the current one is not offered by the
        ...
        // WOLFGATE START: anatomy tab context and save confirmation
        /// <summary>
        ...
        private void SetPreviewRotation(Direction direction)
        {
            ...
            // WOLFGATE START: the picker tiles face the same way as the preview pawn
