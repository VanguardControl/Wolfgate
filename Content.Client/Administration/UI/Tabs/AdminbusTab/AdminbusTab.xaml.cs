...
namespace Content.Client.Administration.UI.Tabs.AdminbusTab
{
    ...
    {
        private readonly WolfgateSpawnUIController _entitySpawningController; // WOLFGATE: categorised spawn menu
        ...
        public AdminbusTab()
        {
            ...
            _entitySpawningController = UserInterfaceManager.GetUIController<WolfgateSpawnUIController>(); // WOLFGATE
