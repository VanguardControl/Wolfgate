...
namespace Content.Client.Administration.UI.Tabs.AdminbusTab
{
    ...
    {
        private readonly WolfgateSpawnUIController _entitySpawningController; // WOLFGATE(Spawning): categorised spawn menu
        ...
        public AdminbusTab()
        {
            ...
            _entitySpawningController = UserInterfaceManager.GetUIController<WolfgateSpawnUIController>(); // WOLFGATE(Spawning)
